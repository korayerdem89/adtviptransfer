      ...
      >
        ...
        <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
              <div>
                ...
                <h2 className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-100 text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-white">
                  Araç <span className="text-gradient-gold">Galerimiz</span>
                </h2>

                <p className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-200 text-gray-400 max-w-xl mt-4">
                  Lüks araç filomuzdan özel görüntüler. Her detayda kalite ve konfor.
                </p>
              </div>
          ...
          <div
            ...
            className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 delay-400 flex gap-6 overflow-x-auto scrollbar-hide px-4 sm:px-6 lg:px-8 pb-4 cursor-grab active:cursor-grabbing"
            ...
            {galleryImages.map((image, index) => (
              ...
              >
                <div
                  ...
                  className="relative w-[280px] sm:w-[350px] lg:w-[400px] h-[200px] sm:h-[250px] lg:h-[280px] rounded-2xl overflow-hidden bg-[#111] border border-gray-800 transition-all duration-500 hover:border-[#d4af37]/50 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] cursor-pointer"
                >
                  <img
                    src={`/gallery/${image}`}
                    alt={`Galeri ${index + 1}`}
