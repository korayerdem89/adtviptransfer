    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Bizimle <span className="text-gradient-gold">İletişime Geçin</span>
          </h2>
          ...
          >
            Rezervasyon, bilgi ve önerileriniz için 7/24 bize ulaşabilirsiniz.
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            {contactInfo.map((info, index) => (
              <div
                key={info.title}
                className={`animate-on-scroll opacity-0 -translate-x-12 transition-all duration-700 delay-${(index + 3) * 100}`}
              >
                <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-[#111] to-[#0a0a0a] border border-gray-800 rounded-xl transition-all duration-300 hover:border-[#d4af37]/30">
                  ...
                  <div>
                    ...
                    {info.href ? (
                      <a
                        href={info.href}
                        className="text-gray-400 hover:text-[#d4af37] transition-colors whitespace-pre-line"
                      >
                        {info.content}
                      </a>
                    ) : (
            ...
            <div
              className="animate-on-scroll opacity-0 -translate-x-12 transition-all duration-700 delay-700 pt-4"
            >
              <p className="text-gray-500 text-sm mb-4">Hızlı İletişim</p>
              <div className="flex flex-wrap gap-3">
                <a
                  href="tel:+905433806649"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#d4af37]/10 border border-[#d4af37]/30 text-[#d4af37] rounded-lg hover:bg-[#d4af37]/20 transition-colors"
                >
                  <Phone className="w-4 h-4" />
                  <span className="text-sm">Hemen Ara</span>
                </a>
                <a
                  href="https://wa.me/905433806649"
                  target="_blank"
          ...
          <div className="lg:col-span-3">
            <div
              className="animate-on-scroll opacity-0 translate-x-12 transition-all duration-700 delay-300 bg-gradient-to-b from-[#111] to-[#0a0a0a] border border-gray-800 rounded-2xl p-8"
            >
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="bg-[#0a0a0a] border-gray-700 text-white placeholder:text-gray-600 focus:border-[#d4af37] focus:ring-[#d4af37]/20"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="subject" className="text-gray-300">
                        Konu <span className="text-[#d4af37]">*</span>
                      </Label>
                      <Input
                        id="subject"
                        name="subject"
                        ...
                        onChange={handleChange}
                        placeholder="Rezervasyon / Bilgi / Öneri"
                        required
                        className="bg-[#0a0a0a] border-gray-700 text-white placeholder:text-gray-600 focus:border-[#d4af37] focus:ring-[#d4af37]/20"
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      required
                      rows={5}
                      className="bg-[#0a0a0a] border-gray-700 text-white placeholder:text-gray-600 focus:border-[#d4af37] focus:ring-[#d4af37]/20 resize-none"
                    />
                  </div>
